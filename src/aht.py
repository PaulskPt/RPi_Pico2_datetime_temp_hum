...
""" Downloaded by @PaulskPt from: https://github.com/etno712/aht """
...
class AHT2x:
    ...
    #@property
    def update(self): # was: is_ready(self):
        """The sensor is busy until the measurement is complete."""
        if bool(self._status() & AHT_STATUS_BUSY):
            return # False
        #return self._measure()
        self._measure()  # get the temperature and humidity values
        
    @property  # added by @PaulskPt
    def is_ready(self):
    ...
    def _measure(self):
        ...
        self._buf[0] = AHT_CMD_TRIGGER  # = 0xAC
        self._buf[1] = 0x33
        self._buf[2] = 0x00
        self.i2c.writeto(self.address, self._buf[:3])
